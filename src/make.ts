import {HostEnum} from "@decisionrules/decisionrules/dist/defs/enums";
import DecisionRules from "@decisionrules/decisionrules";
import {DecisionRulesAuditOpt, SolverOptions} from "@decisionrules/decisionrules/dist/defs/models";
...
const opt = {
    ...
    host: HostEnum.GLOBAL_CLOUD || "domain",
    bi_host: HostEnum.GLOBAL_CLOUD || "bi_domain"
};

const dr = new DecisionRules(opt);

//audit logs options
const auditLogsOptions: DecisionRulesAuditOpt = {
    page: "1",
    page_size: "5",
    limit: "10",
...
const auditLogsToDeleteOptions: DecisionRulesAuditOpt = {
    page: "2",
    page_size: "5",
    limit: "1",
   // corrIds: [correlationId],
...
//deleteAuditLogs
dr.bi.deleteAuditLogs(auditLogsToDeleteOptions).then((result: any) => {
